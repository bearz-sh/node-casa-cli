...
export const describe = 'lists the name of settings for an environment configuration'
...
export const handler = function(args: Arguments) {
    listSecretNames(args.env as string | undefined).forEach(name => console.log(success(name)));
}